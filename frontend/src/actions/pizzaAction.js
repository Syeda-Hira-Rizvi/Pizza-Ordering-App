...
export const addPizza = (pizza) => async (dispatch) => {
  ...
  try {
    await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/pizzas/addpizza`, { pizza });
...
export const getPizzaById = (pizzaId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/pizzas/getpizzabyid`, { pizzaId });
...
export const updatePizza = (updatedPizza) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/pizzas/updatepizza`, {
      updatedPizza,
    });
...
export const deletePizza = (pizzaId) => async (dispatch) => {
  try {
    await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/pizzas/deletepizza`, { pizzaId });
...
export const filterPizza = (searchkey, category) => async (dispatch) => {
  ...
  dispatch({ type: "GET_PIZZAS_REQUEST" });
  try {
    const res = await axios.get(`${import.meta.env.VITE_APP_BASE_URL}/pizzas/getAllPizzas`);
